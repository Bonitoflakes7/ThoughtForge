...
export type NotificationItem = { id: string; type: "like" | "comment" | "fork" | "follow" | "message"; message: string; actor: Author; target_id: string | null; is_read: boolean; created_at: string };
